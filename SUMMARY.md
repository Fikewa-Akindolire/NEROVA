...
Neurova is a prototype pain monitoring system that uses a consumer-grade EEG headset to read brainwave activity in real time and translate it into a continuous, objective pain score with no patient input required.
...
The hardware is a Muse 2 EEG headset with four electrodes, 256 samples per second, at about $250. The entire software stack is open source. No specialized clinical equipment. No proprietary systems.
...
Alpha wave activity (8-12 Hz) dominates when the brain is relaxed. When pain is present that signal gets suppressed and the brain shifts out of its resting rhythm. Theta wave activity (4-8 Hz) increases during pain processing, particularly in the anterior cingulate cortex, a region closely tied to how the brain perceives and responds to pain stimuli.
...
**Protocol:** Two minute resting baseline with eyes closed, then a three minute pain stimulus recording with a 30 second rest window before the stimulus begins, then frequency band analysis comparing the two sessions.
